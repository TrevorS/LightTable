...
Zig support for Light Table, through
[`zls`](https://microsoft.github.io/language-server-protocol/implementors/servers/).

One declaration and no code.

## Installing the server

    zig fetch --global zls, or your package manager

> **Archived.** This is Light Table's README as it stood before the 2026
> modernization work, kept because it records the project as it was and because
> older discussions link to it. Several services it references — Travis CI,
> Semaphore, AppVeyor, Freenode — no longer exist, and the build instructions no
> longer apply.
>
> The current README is [in the repository root](../README.md).

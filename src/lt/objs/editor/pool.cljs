...
(cmd/command {:command :editor.kill-line
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "killLine")))})
...
(cmd/command {:command :editor.delete-line
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "deleteLine")))})
...
(cmd/command {:command :editor.delete-line-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "delLineLeft")))})
...
(cmd/command {:command :editor.doc-start
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goDocStart")))})
...
(cmd/command {:command :editor.doc-end
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goDocEnd")))})
...
(cmd/command {:command :editor.line-start
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goLineStart")))})
...
(cmd/command {:command :editor.line-start-smart
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goLineStartSmart")))})
...
(cmd/command {:command :editor.line-end
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goLineEnd")))})
...
(cmd/command {:command :editor.line-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goLineRight")))})
...
(cmd/command {:command :editor.line-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goLineLeft")))})
...
(cmd/command {:command :editor.line-up
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goLineUp")))})
...
(cmd/command {:command :editor.line-down
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goLineDown")))})
...
(cmd/command {:command :editor.page-up
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goPageUp")))})
...
(cmd/command {:command :editor.page-down
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goPageDown")))})
...
(cmd/command {:command :editor.char-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goCharLeft")))})
...
(cmd/command {:command :editor.char-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goCharRight")))})
...
(cmd/command {:command :editor.column-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goColumnLeft")))})
...
(cmd/command {:command :editor.column-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goColumnRight")))})
...
(cmd/command {:command :editor.word-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goWordLeft")))})
...
(cmd/command {:command :editor.word-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goWordRight")))})
...
(cmd/command {:command :editor.group-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goGroupLeft")))})
...
(cmd/command {:command :editor.group-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "goGroupRight")))})
...
(cmd/command {:command :editor.delete-char-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "delCharBefore")))})
...
(cmd/command {:command :editor.delete-char-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "delCharAfter")))})
...
(cmd/command {:command :editor.delete-word-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "delWordBefore")))})
...
(cmd/command {:command :editor.delete-word-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "delWordAfter")))})
...
(cmd/command {:command :editor.delete-group-left
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "delGroupBefore")))})
...
(cmd/command {:command :editor.delete-group-right
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "delGroupAfter")))})
...
(cmd/command {:command :editor.transpose-chars
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "transposeChars")))})
...
(cmd/command {:command :editor.new-line-indent
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "newlineAndIndent")))})
...
(cmd/command {:command :editor.toggle-overwrite
              ...
              :exec (fn []
                      (when-let [ed (last-active)]
                        (editor/exec-command! ed "toggleOverwrite")))})
